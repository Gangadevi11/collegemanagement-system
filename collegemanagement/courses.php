	...
	<div class="blog-cource">
		<div class="container">
			<div class="title-div">
				...
				<!--php query-->
				<?php
    require("admin/connection.php"); // Ensure this file exists and is in the correct location.
...
?>
    ...
    <div class="course">
        <h6><?php echo $row["course name"]; ?></h6>
        <p class="price"><?php echo '$' . $row["course price"]; ?></p>
        <p><?php echo $row["course description"]; ?></p>
        <img src="<?php echo 'admin/images/' . $row['image']; ?>" alt="<?php echo $row['course name']; ?>">
                   
		<p><?php echo $row['number'];?></p>
		<p><?php echo $row['price'];?></p>
		<br><br>
		<a href="edit.php?edit=<?php echo $row['id'];?>"btn btn-primary btn-sm">Book now</a>
        <div class="clearfix"></div>
    </div>
