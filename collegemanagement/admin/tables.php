            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
						<li>
							<a href="main.php"><i class="fa fa-home nav_icon"></i>Dashboard</a>
						</li>
						<li>
						...
						<li class="">
							...
							<ul class="nav nav-second-level collapse">
								<li>
									<a href="forms.php">Add Students<span class="nav-badge-btm">08</span></a>
								</li>
								<li>
...
// Select students added by the logged-in staff member
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<br><br>
					<br>
					<a href="exporttoexcel.php">
  <button style="color:black; background-color:green;">Export to Excel</button>
    </a>
                <a href="exporttopdf.php">
					<button style="color:black; background-color:red;">Export to pdf </button>
                   </a> 
            ...
            <th>Status</th>
							...
							<?php
if ($count > 0) {
    $serial = 1;  // Initialize serial number before the loop
...
?>
        <tr>
			...
			<td><a href="edit.php?edit=<?php echo $row['id'];?>"btn btn-primary btn-sm">edit</a>
		
       <br><br>
  			<a href='delete.php?id=<?php echo $row['id']; ?>'btn btn-primary btn-sm'>delete</a>
			 </td>
...
if ($row['status'] == 1) {
    ...
    echo '<button style="color:white;background-color:green";>Approved</button>';
} else {
    echo '<button  style="color:white;background-color:red";>Rejected</button>';
}
?>
<br><br>
<a href="approval.php?id=<?php echo $row['id']; ?>">Approve</a><br>
...
<?php
        $serial++;  // Increment serial number inside the loop
    }
}
?>
							</tbody>
