...
<body class="cbp-spmenu-push">
 ...
 <?php
    ...
    $res = $con->query("SELECT formaction.*, states.sname, countries.name 
    FROM formaction 
    JOIN states ON formaction.state = states.stat_id 
...
?>
        <tr>
			...
			<td><a href="useredit.php?edit=<?php echo $row['id'];?>"btn btn-primary btn-sm">edit</a>
		
       <br><br>
  			<a href='userdelete.php?id=<?php echo $row['id']; ?>'btn btn-primary btn-sm'>delete</a>
