...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2024 at 07:54 AM
...
CREATE TABLE `form` (
  ...
  `course price` varchar(255) NOT NULL,
...
INSERT INTO `form` (`id`, `course name`, `course price`, `course description`, `image`, `number`, `price`) VALUES
(8, 'cse', '15000', 'Sed interdum interdum accumsan. Aenean nec purus ac orci finibus facilisis. In sit amet placerat nisl, in auctor sapien.\r\n						Donec ultricies faucibus ante in mattis earum rerum delectus in auctor sapien.', 'cse.jpg', '', ''),
(9, 'IT', '20000', 'Sed interdum interdum accumsan. Aenean nec purus ac orci finibus facilisis. In sit amet placerat nisl, in auctor sapien. Donec ultricies faucibus ante in mattis earum rerum delectus in auctor sapien.', 'it.jpg', '', ''),
(11, 'Mechanical Engineering', '15000', ' mechanical course is a hardeware enginerr department very value dept in current year. many courses available the dept high salay package\r\n', 's1.jpg', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `formaction`
--
...
--
-- Dumping data for table `formaction`
--

INSERT INTO `formaction` (`id`, `Name`, `email`, `dob`, `gender`, `pno`, `address`, `course`, `countries`, `state`, `image`) VALUES
(1, 'ganga', 'ganga@gmail.com', '2024-10-10', 'female', '0987654321', 'sdasdsaf', 'btech', 'india', 'california', 'mech.jfif'),
(3, 'Antarctica', 'nnn@gmail.com', '2024-10-10', 'female', '0987654321', 'hghj', 'btech', '32', 'sel_state', 'mech.jfif'),
(5, 'devi', 'jjmm@gmail.com', '2024-10-16', 'female', '0987654321', 'zzdzf dfd', 'btech', '101', '35', 'c2.jpg'),
(6, 'ram', 'ganga@gmail.com', '2024-10-16', 'male', '0987654321', 'drewt dd', 'bcom', '4', '166', 'c3.jpg');
...
INSERT INTO `forms` (`id`, `Full Name`, `Email`, `Date of Birth`, `Gender`, `Course`, `Address`, `Phone Number`, `image`, `status`) VALUES
(1, 'ganga', 'ganga@gmail.com', '2024-10-18', 'male', 'bcom', 'hghjh', '5678987654', 'c2.jpg', 1),
(3, 'abi', 'nnn@gmail.com', '2024-10-18', 'female', 'btech', 'hguj hioouij', '1234567890', 'c3.jpg', 0),
(21, 'ram', 'ramn@gmail.com', '2024-10-09', 'Male', 'btech', ' la bghg nbj\r\n                     \r\n                     \r\n    ', '5678987654', 'img1.png', 1),
(25, 'Ganga', 'ganga@gmail.com', '2024-10-05', 'female', 'bcom', 'nm oiiu', '1234567890', '1.png', 0),
(26, 'malar', 'malar@gmail.com', '2024-10-09', 'female', 'ba', 'mnbv ytyuty', '5678987654', 'te3.jpg', 1),
(28, 'tejas', 'tejas@gmail.com', '2024-10-10', 'male', 'bcom', 'bvhjg hgh', '5678987654', 't3.jpg', 0);
...
(1, 'ganga@gmail.com', '12345'),
(2, 'devi@gmail.com', '123'),
(3, 'viji@gmail.com', '123');
...
--
-- Indexes for table `formaction`
--
ALTER TABLE `formaction`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `formaction`
--
ALTER TABLE `formaction`
